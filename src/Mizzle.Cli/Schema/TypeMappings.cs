    ...
    public static IReadOnlyList<TypeMapping> For(ProviderKind provider)
        => provider switch
        {
            ...
            [
                ...
                new("int2", "short", "SmallInt"),
                new("numeric", "decimal", "Numeric"),
                new("money", "decimal", "Money"),
                new("real", "float", "Real"),
                new("float4", "float", "Real"),
                new("double precision", "double", "DoublePrecision"),
                new("float8", "double", "DoublePrecision"),
                new("timestamp without time zone", "DateTime", "Timestamp"),
                new("timestamp", "DateTime", "Timestamp"),
                new("time without time zone", "TimeOnly", "Time"),
                new("time", "TimeOnly", "Time"),
                new("bytea", "byte[]", "Bytea"),
                new("json", "string", "Json"),
                new("jsonb", "string", "Jsonb"),
            ],
